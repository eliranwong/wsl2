...
sudo apt install geany geany-plugins rxvt-unicode gnome-terminal thunar sqlitebrowser firefox-esr flashplugin-nonfree falkon gthumb gedit gnome-keyring libsecret* libreoffice gimp
